	...
	<div class="header">
		<div class="container">
			...
			<div class="header-right">
				...
				<a href="${localeFr}"><span class="lng-sprite fr">Fran�ais</span></a>
		...
		<footer>
			...
			<div class="container">
				...
				<div class="copyrights">
					<p> � 2016 Magicabrac. Tous droits r�serv�s | Design by  <a href="http://w3layouts.com/" about="_blank"> W3layouts</a></p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
